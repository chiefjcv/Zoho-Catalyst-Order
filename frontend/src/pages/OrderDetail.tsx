              ...
              <div className="border-t border-gray-300 pt-1">
                ...
                <table className="w-full border-collapse border border-gray-300 text-xs">
                  <thead className="bg-gray-100">
                    <tr>
                      <th className="border border-gray-300 px-2 py-1 text-left font-semibold">Eye</th>
                      <th className="border border-gray-300 px-2 py-1 text-center font-semibold">Sph</th>
                      <th className="border border-gray-300 px-2 py-1 text-center font-semibold">Cyl</th>
                      <th className="border border-gray-300 px-2 py-1 text-center font-semibold">Axis</th>
                      <th className="border border-gray-300 px-2 py-1 text-center font-semibold">Add.</th>
                      <th className="border border-gray-300 px-2 py-1 text-center font-semibold">VA</th>
                      <th className="border border-gray-300 px-2 py-1 text-center font-semibold">Prism. Bases</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-300 pt-1 mt-2">
                ...
                <table className="w-full border-collapse border border-gray-300 text-xs">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 px-2 py-1 font-semibold">OD</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.sph_od ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.cyl_od ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.axis_od ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.add_od ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.va_od ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.prism_bases_od ?? '—'}</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-2 py-1 font-semibold">OS</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.sph_os ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.cyl_os ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.axis_os ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.add_os ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.va_os ?? '—'}</td>
                      <td className="border border-gray-300 px-2 py-1 text-center">{order.prism_bases_os ?? '—'}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
